...
CASES = [
    ...
    {'name': 'k8gb-lbcontroller-iam',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              ...
              'assertResources': [{'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
                                   ...
                                   # The identity tag is what makes this role
                                   # importable; without it a stateless bootstrap
                                   # creates a second one. IAM is global, so the
                                   # render carries no region here.
                                   'spec': {'forProvider': {'tags': {'upbound.io/ctp-id': 'test-cp',
                                                                     'upbound.io/ctp-resource': 'lb-controller-role'}}}},
                                  {'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
                                   'kind': 'Policy',
                                   'metadata': {'name': 'test-cp-lb-controller'},
                                   'spec': {'forProvider': {'tags': {'upbound.io/ctp-id': 'test-cp',
                                                                     'upbound.io/ctp-resource': 'lb-controller-policy'}}}},
                                  {'apiVersion': 'helm.m.crossplane.io/v1beta1',
                                   'kind': 'Release',
                                   'metadata': {'name': 'test-cp-envoy-gateway'}},
                                  {'apiVersion': 'protection.crossplane.io/v1beta1',
    ...
    {'name': 'namespaced-backup',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              ...
              'assertResources': [{'apiVersion': 's3.aws.m.upbound.io/v1beta1',
                                   ...
                                   'spec': {'forProvider': {'region': 'us-east-1',
                                                            'tags': {'upbound.io/ctp-id': 'test-cp',
                                                                     'upbound.io/ctp-resource': 'backup-bucket'}}}},
                                  {'apiVersion': 'kubernetes.m.crossplane.io/v1alpha1',
                                   'kind': 'Object',
                                   'metadata': {'name': 'test-cp-backup-config',
                                                'namespace': 'platform'}},
    ...
    {'name': 'import-derives-oidc-and-attachment',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              ...
              'assertResources': [{'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
                                   ...
                                   'spec': {'forProvider': {'tags': {'upbound.io/ctp-id': 'test-cp',
                                                                     'upbound.io/ctp-resource': 'oidc-provider'}}}},
                                  # The IRSA role and policy are tagged for the same
                                  # reason; neither was asserted before, so dropping
                                  # their resource_tag left the suite green.
                                  {'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
                                   'kind': 'Role',
                                   'metadata': {'name': 'test-cp-backup-irsa'},
                                   'spec': {'forProvider': {'tags': {'upbound.io/ctp-id': 'test-cp',
                                                                     'upbound.io/ctp-resource': 'backup-irsa-role'}}}},
                                  {'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
                                   'kind': 'Policy',
                                   'metadata': {'name': 'test-cp-backup-s3'},
                                   'spec': {'forProvider': {'tags': {'upbound.io/ctp-id': 'test-cp',
                                                                     'upbound.io/ctp-resource': 'backup-s3-policy'}}}},
                                  {'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
    ...
    # The sweep checks the ARN type against the logical name. A subnet tagged
    # ctp-resource: vpc would otherwise be a second "vpc" candidate, and the
    # ambiguity would leave the real VPC unimported.
    {'name': 'import-tag-sweep-checks-arn-type',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              'context': {'import': {'tagged': [{'arn': 'arn:aws:ec2:us-east-1:123456789012:vpc/vpc-0mine11223344556',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'vpc'}},
                                               {'arn': 'arn:aws:ec2:us-east-1:123456789012:subnet/subnet-0evil11223344556',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'vpc'}}]}},
              'xr': {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                     'kind': 'ControlPlane',
              ...
              'assertResources': [{'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                   ...
                                   'metadata': {'name': 'test-cp'},
                                   'spec': {'parameters': {'externalNames': {'vpc': 'vpc-0mine11223344556'}}}}]}},
    # VPCs and gateways have no describe of their own, and the sweep keeps deleted
    # ones under the live tag. The live route table vouches for both - its vpcId
    # and its 0.0.0.0/0 gateway - so the phantoms are dropped. Without that both
    # keys are ambiguous and absent.
    {'name': 'import-narrows-vpc-and-igw-to-live-route-table',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              'context': {'import': {'tagged': [{'arn': 'arn:aws:ec2:us-east-1:123456789012:vpc/vpc-0dead11223344556',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'vpc'}},
                                               {'arn': 'arn:aws:ec2:us-east-1:123456789012:vpc/vpc-0live99887766554',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'vpc'}},
                                               {'arn': 'arn:aws:ec2:us-east-1:123456789012:internet-gateway/igw-0dead11223344556',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'igw'}},
                                               {'arn': 'arn:aws:ec2:us-east-1:123456789012:internet-gateway/igw-0live99887766554',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'igw'}}],
                                    'subnets': [],
                                    'routeTables': [{'routeTableId': 'rtb-0live99887766554',
                                                     'vpcId': 'vpc-0live99887766554',
                                                     'tags': {'upbound.io/ctp-id': 'test-cp',
                                                              'upbound.io/ctp-resource': 'rt'},
                                                     'associations': [],
                                                     'routes': [{'destinationCidrBlock': '0.0.0.0/0',
                                                                 'gatewayId': 'igw-0live99887766554',
                                                                 'state': 'active'}]}]}},
              'xr': {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                     'kind': 'ControlPlane',
                     'metadata': {'name': 'test-cp'},
              ...
              'assertResources': [{'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                   'kind': 'Network',
                                   'metadata': {'name': 'test-cp'},
                                   'spec': {'parameters': {'externalNames': {'vpc': 'vpc-0live99887766554',
                                                                             'igw': 'igw-0live99887766554'}}}}]}},
    # Injected external-names are carried forward. Crossplane applies composed
    # resources with SSA and upjet writes the annotation back only when it
    # changes, so a reconcile that omits it deletes it. Here there is no import
    # context at all - the XR switched back to the default Composition - and the
    # observed values survive, locally and in both sub-XRs' externalNames.
    {'name': 'import-carries-forward-observed-external-names',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              ...
              'observedResources': [{'apiVersion': 'ec2.aws.m.upbound.io/v1beta1',
                                     ...
                                     'metadata': {'name': 'test-cp-k8gb-eip-0',
                                                  'annotations': {'crossplane.io/composition-resource-name': 'k8gb-eip-0',
                                                                  'crossplane.io/external-name': 'eipalloc-0kept'}}},
                                    {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                     'kind': 'Network',
                                     'metadata': {'name': 'test-cp',
                                                  'annotations': {'crossplane.io/composition-resource-name': 'network'}},
                                     'spec': {'parameters': {'externalNames': {'vpc': 'vpc-0kept11223344556'}}}},
                                    {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                     'kind': 'EKS',
                                     'metadata': {'name': 'test-cp',
                                                  'annotations': {'crossplane.io/composition-resource-name': 'eks-cluster'}},
                                     'spec': {'parameters': {'externalNames': {'ebsCSIDriverPodIdentityAssociation': 'a-kept0000000000000'}}}}],
              'assertResources': [{'apiVersion': 'ec2.aws.m.upbound.io/v1beta1',
                                   'kind': 'EIP',
                                   'metadata': {'name': 'test-cp-k8gb-eip-0',
                                                'annotations': {'crossplane.io/external-name': 'eipalloc-0kept'}}},
                                  {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                   'kind': 'Network',
                                   'metadata': {'name': 'test-cp'},
                                   'spec': {'parameters': {'externalNames': {'vpc': 'vpc-0kept11223344556'}}}},
                                  {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                   ...
                                   'metadata': {'name': 'test-cp'},
                                   'spec': {'parameters': {'externalNames': {'ebsCSIDriverPodIdentityAssociation': 'a-kept0000000000000'}}}}]}},
    # The observed external-name wins over a different discovered one. Forcing
    # the discovered value would repoint the MR at another resource and orphan
    # the one it manages.
    {'name': 'import-observed-external-name-wins-over-discovery',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              'context': {'import': {'tagged': [{'arn': 'arn:aws:ec2:us-east-1:123456789012:elastic-ip/eipalloc-0new',
                                                'tags': {'upbound.io/ctp-id': 'test-cp',
                                                         'upbound.io/ctp-resource': 'k8gb-eip-0'}}]}},
              'xr': {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                     'kind': 'ControlPlane',
              ...
              'observedResources': [{'apiVersion': 'ec2.aws.m.upbound.io/v1beta1',
                                     ...
                                     'metadata': {'name': 'test-cp-k8gb-eip-0',
                                                  'annotations': {'crossplane.io/composition-resource-name': 'k8gb-eip-0',
                                                                  'crossplane.io/external-name': 'eipalloc-0old'}}}],
              'assertResources': [{'apiVersion': 'ec2.aws.m.upbound.io/v1beta1',
                                   'kind': 'EIP',
                                   'metadata': {'name': 'test-cp-k8gb-eip-0',
                                                'annotations': {'crossplane.io/external-name': 'eipalloc-0old'}}}]}},
    # The LB controller's role-policy attachment is derived like the backup one:
    # role-name/policy-arn, both deterministic. Without it the attachment is
    # imported only through Create.
    {'name': 'import-derives-lb-controller-attachment',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              ...
              'observedResources': [{'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                     ...
                                     'metadata': {'name': 'test-cp',
                                                  'annotations': {'crossplane.io/composition-resource-name': 'eks-cluster'}},
                                     'status': {'eks': {'clusterArn': 'arn:aws:eks:us-east-1:123456789012:cluster/test-cp-eks'}}},
                                    {'apiVersion': 'aws.platform.upbound.io/v1alpha1',
                                     'kind': 'Network',
                                     'metadata': {'name': 'test-cp',
                                                  'annotations': {'crossplane.io/composition-resource-name': 'network'}},
              ...
              'assertResources': [{'apiVersion': 'iam.aws.m.upbound.io/v1beta1',
                                   'kind': 'RolePolicyAttachment',
                                   'metadata': {'name': 'test-cp-lb-controller-attach',
                                                'annotations': {'crossplane.io/external-name': 'test-cp-lb-controller/arn:aws:iam::123456789012:policy/test-cp-lb-controller'}}}]}},
    # ObserveOnly makes no changes, including to the two resources whose policy
    # is fixed rather than swept: the backup bucket (tagged on every reconcile)
    # and the knative operator (installed if missing).
    {'name': 'management-mode-observe-only-pins-fixed-policies',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              ...
              'assertResources': [{'apiVersion': 's3.aws.m.upbound.io/v1beta1',
                                  ...
                                  {'apiVersion': 'helm.m.crossplane.io/v1beta1',
                                   ...
                                   'metadata': {'name': 'test-cp-knative-operator'},
                                   'spec': {'managementPolicies': ['Observe']}}]}},
    # Deprovision pushes no Update and the bucket is never deleted. Create stays,
    # as for every resource under Deprovision, so a missing bucket does not hold
    # the XR off Ready.
    {'name': 'management-mode-deprovision-never-updates-backup-bucket',
     'spec': {'compositionPath': 'apis/ctp/composition.yaml',
              'xrdPath': 'apis/ctp/definition.yaml',
              'validate': True,
              'timeoutSeconds': 60,
              ...
              'assertResources': [{'apiVersion': 's3.aws.m.upbound.io/v1beta1',
                                   'kind': 'Bucket',
                                   'metadata': {'name': 'test-cp-backup-bucket'},
                                   'spec': {'managementPolicies': ['Observe', 'Create'],
                                            'forProvider': {'region': 'us-east-1'}}}]}},
]
